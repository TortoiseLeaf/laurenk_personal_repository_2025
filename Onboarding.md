...
The following is a set of guidelines for contributing to the MauiScreenTime app usage tracker. These are mostly guidelines, not steadfast rules. Use your best judgment, and feel free to propose changes to this document in a pull request.

#### Table Of Contents

[Code of Conduct](#code-of-conduct)

[FAQ](#i-dont-want-to-read-this-whole-thing-i-just-have-a-question)
